...
@Autonomous(name="Straight and Park Delay", group="Autonomous")  // @Autonomous(...) is the other common choice
@Disabled
public class AutoStraightNParksDelay extends LinearOpMode {
