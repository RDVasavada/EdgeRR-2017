...
@Autonomous(name="Blue Two 2 Particle", group="Autonomous")  // @Autonomous(...) is the other common choice
@Disabled
public class BlueTwo2NEW extends LinearOpMode {
...
//****  STEP 1 ************ Drive straight, shoot, rotate to line
            ...
            // Shoot 2 particles
            sleep(200);// to keep from hitting
...
//**** STEP 2  ************Rotate and drive toward wall
        // sleep(3000);
           ...
           robot.rotateClockwiseEncoder(49,1);  //was 55
            ...
            telemetry.update();
           // sleep(3000);
           robot.rotateByEncoderCorrection(51,0.4,2); // correct to get closer to 52
  ...
  //*****************************************************************************************
       ...
       //     robot.allWheelsStop();
            ...
            robot.waitForTick(150);
            // sleep(5000);
            robot.rotateByEncoderCorrection(90,0.4,2); // correct to get closer to 90
            telemetry.addData("Heading ADJ:  ", "%d", robot.gyro.getHeading());
            telemetry.update();
