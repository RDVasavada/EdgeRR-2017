...
@Autonomous(name="Straight and STOP", group="Autonomous")  // @Autonomous(...) is the other common choice
@Disabled
public class AutoStraightNPstop extends LinearOpMode {
...
// particlShootByEncoder
          ...
          // Move forward then shoot - one rev = 2240 / (4* 3.14) = 178 pulses per inch
           robot.autoDriveForward(4000,1);
            ...
            robot.autoDriveBackward(1500,1); //backup and get out of the way


           // robot.rotateToDirection(telemetry, 30);

            // Park on Ramp
            //robot.autoDriveForward(1300,1);
     //     Stop
            robot.allWheelsStop();
         stop();
            //**************************************************************************************
