...
@Autonomous(name="Blue Two 1 Particle", group="Autonomous")  // @Autonomous(...) is the other common choice
@Disabled
public class BlueTwo1 extends LinearOpMode {
...
//**** STEP 2  ************Rotate and drive toward wall
        // sleep(3000);
           ...
           robot.rotateClockwiseEncoder(49,1);  //was 55
...
/*            while ((realDist < 14) && opModeIsActive()) {
  ...
  */              //robot.rotateToDirection(telemetry, 90, 30, .8, .05);// correct if not at Rotate back to 90
            ...
            telemetry.update();
                ...
                robot.strafeLeft(.25);//  CAUTION  will keep going forever?was .3
                telemetry.addData("Line Tracker... ", "??");
                telemetry.update();
...
// **** STEP 6    Sense Colors and go and push 2st Beacon!!  *****************************
           ...
           robot.rotateCounterClockwiseEncoder(43,1);
            telemetry.addData("Heading After  ", "%d", robot.gyro.getHeading());
           // robot.allWheelsStop();
          ...
          //  robot.allWheelsStop();
           // telemetry.addData("Heading After  ", "%d", robot.gyro.getHeading());
            telemetry.update();
            robot.autoDriveBackward(4500,1);
            robot.autoDriveBackward(500,.5);
