...
@Autonomous(name="Red Two 2 USE", group="Autonomous")  // @Autonomous(...) is the other common choice
@Disabled
public class RedTwo2NEW3 extends LinearOpMode {
