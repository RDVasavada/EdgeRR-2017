...
public class EdgeTeleopB extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            if (gamepad1.a) {
                robot.clampServoLeft.setPosition(0.4);
                robot.clampServoRight.setPosition(0);
                telemetry.addData("Clamp servos ", "closing");
            } else if (gamepad1.b) {
                robot.clampServoLeft.setPosition(0.7);
                robot.clampServoRight.setPosition(0.3);
                telemetry.addData("Clamp servos ", "opening halfway");
            } else if (gamepad1.y) {
                robot.clampServoLeft.setPosition(1);
                robot.clampServoRight.setPosition(0.6);
